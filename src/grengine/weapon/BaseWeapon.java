...
public class BaseWeapon extends Entity {
	...
	public void onUse(Player user)
	{
		...
		user.setActiveWeapon(this);
		this.remove();
		System.out.println(user+" picked up "+this);
	...
	public void setNextShot(float nextShot) {
		this.nextShot = nextShot;
	}
	public float getNextShot() {
		return nextShot;
	}
	public void setNextBurstShot(float nextBurstShot) {
		this.nextBurstShot = nextBurstShot;
	}
	public float getNextBurstShot() {
		return nextBurstShot;
	}
}
